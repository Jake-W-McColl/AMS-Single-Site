...
Procedure Database_CheckVersion(Quiet = #True)
  ...
  If Version < 11
    Debug "*** HR  *** New database version is 11...."
...
Procedure Init_Menu()
  ...
  If CreatePopupMenu(6) ;/ Original
    ...
    MenuBar()
    MenuItem(#Menu_Popup6_Original_Usage_Add,"Add Roll Usage");tTxt(#Str_Deleteselectedreadingrecord))
    MenuBar()
  ...
  If CreatePopupMenu(7) ;/ Historical
    ...
    MenuBar()
    MenuItem(#Menu_Popup7_Historical_Usage_Add,"Add Roll Usage");tTxt(#Str_Deleteselectedreadingrecord))
    MenuBar()
...
; CursorPosition = 8695
; FirstLine = 3429
; Folding = ZBAAEACAAAACBAEeCAAAgo0EAAAAgheP9uZzFj
; EnableXP
; EnableUser
