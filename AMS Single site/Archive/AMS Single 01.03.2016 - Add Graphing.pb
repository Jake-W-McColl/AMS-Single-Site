...
If Multi_Site_Mode = 0
  Program_Version.S = " V1.4 - Single-Site " ;/DNT
Else
  Program_Version.S = " V1.4 - Multi-Site " ;/DNT
EndIf
...
Procedure PDF_Header()
  ...
  Else
    ; this is OK on direct print, but not on print to pdf... why?
...
;  EndIf
  ...
  SaveImage(#Image_OEM_Logo,"OEM\OEM Logo PDF.jpg",#PB_ImagePlugin_JPEG,0,24)
...
; CursorPosition = 10799
; FirstLine = 3899
; Folding = QIAAAAAgAGAAAATAwR3BABBw6BSEJAEAH4-
; EnableUnicode
; EnableXP
; EnableUser
; UseIcon = Images\AniCAM_Mini_T.ico
; Executable = Executable\Anilox Management System v1.4.exe
; Warnings = Display
; EnablePurifier
