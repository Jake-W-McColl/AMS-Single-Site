...
Procedure Database_CheckVersion(Quiet = #True)
  ...
  If Version < 11
    Database_Update(#Databases_Master,"Create TABLE [AMS_ReportLayouts] ([ID] INTEGER PRIMARY KEY, [Name] Char, [SortField] Int, [SortDirection] Int, [Type] Int, [Fields] char);",#PB_Compiler_Line) ;/DNT
    Database_Update(#Databases_Master, "INSERT INTO AMS_ReportLayouts (Name, SortField, SortDirection, Type, Fields) VALUES ('Default',0,0,0,'0||2||3||1||4||5||6||7||13||');",#PB_Compiler_Line)     ;/DNT
    ...
    AddedText + "Version 11: New Layout options added."+Chr(10)                                                                                                                                       ;/DNT
    NewVersion = 11
  EndIf
  ...
  ForEach ReportData()
    ...
    For MyLoop = 1 To Report_Layout()\Fieldcount
      ...
      Select Report_Layout()\FieldBreakdown[myLoop]\Value
        ...
        Case #ReportField_GeneralHistory
          Txt + GeneralHistoryLookup(Str(ReportData()\ID)+Report_Layout()\FieldBreakdown[myLoop]\GHString) + Chr(10)
      EndSelect
    Next
...
Procedure Refresh_Presets_List(KeepSelection.i = #False)
  ...
  EndIf 
EndProcedure
Procedure Refresh_Layouts(KeepSelection.i = #False)
  Protected myLoop.i, onfield.i, CVal.i
  
  ;/ Populate Layout list
  ClearList(Report_Layout())
  
  If DatabaseQuery(#Databases_Master,"Select ID, Name, SortField, SortDirection,Type, Fields From AMS_ReportLayouts") ;/ 
    While NextDatabaseRow(#Databases_Master)  
      ...
      Report_Layout()\FieldSelection.s = GetDatabaseString(#Databases_Master,5) ; PJ20190625
    ...
    If IsGadget(#Gad_ReportLayout_Combo)
      CVal = GetGadgetState(#Gad_ReportLayout_Combo)
      ...
      Select KeepSelection
        Case 1
          SetGadgetState(#Gad_ReportLayout_Combo,CVal)
        Case 2
          SetGadgetState(#Gad_ReportLayout_Combo,CountGadgetItems(#Gad_ReportLayout_Combo))
        Default
          SetGadgetState(#Gad_ReportLayout_Combo,0)
      EndSelect
        ...
        Select EventGadget()
          ...
          Case #Settings_GeneralHistoryList_Delete
            If GetGadgetState(#Settings_GeneralHistoryList_List) > -1
              ...
              If MessageRequester(tTxt(#Str_Warning),tTxt(#Str_DeleteLayout)+": ["+ResultS+"] - "+tTxt(#Str_areyousure)+"?",#PB_MessageRequester_YesNo) = #PB_MessageRequester_Yes
...
Procedure Init_Layout(Type.i)
  ...
  Width.i = 440 : Height.i = 380 : Editting = 0
  ...
  Y = 6
  TextGadget(#Gad_Presets_Name_Text,4,Y + 2,80,20,tTxt(#Str_LayoutName)+":")
  StringGadget(#Gad_ReportLayout_Name,90,Y,320,20,"") : Y + 22
  
  ;/PJ20190520 - adding field selection options
  FrameGadget(#Gad_ReportLayout_FieldSelection_Frame,4,Y,Width - 8,320,tTxt(#Str_ReportFieldSelection)) : Y + 16
  ...
  ButtonGadget(#Gad_ReportLayout_AddField,14,Y,140,20,tTxt(#Str_Addselectedfield)+" >>")
  ButtonGadget(#Gad_ReportLayout_FieldList_OrderUp,160,Y,140,20,tTxt(#Str_OrderUp))
  
  Y + 20
  
  ButtonGadget(#Gad_ReportLayout_AddGeneralHistory,14,Y,140,20,tTxt(#Str_AddGeneralHistoryfield))
  ButtonGadget(#Gad_ReportLayout_FieldList_OrderDown,160,Y,140,20,tTxt(#Str_OrderDown))
  
  Y + 20
  
  ;ComboBoxGadget(#Gad_ReportLayout_AddGeneralHistoryCombo,14,Y,100,20)
  ButtonGadget(#Gad_ReportLayout_FieldList_Remove,160,Y,140,20,tTxt(#Str_Removeselected))
  
  Y = 44 : X = 308
  
  TextGadget(#Gad_ReportLayout_SortBy_Combo_Text,X,Y,94,20,tTxt(#Str_Sortby)+":") : Y + 22
  ComboBoxGadget(#Gad_ReportLayout_SortBy_Combo,x+4,y,112,20) : Y + 28
        ...
        If View = 0 ;/ Roll report
          ...
          For Myloop = 0 To CountGadgetItems(#Gad_Report_ReportList)-1
            ...
            For Column = 0 To ColumnCount
              ...
              XLSFunc_WriteCellSFast(ExcelObject, Online, Column+1,GetGadgetItemText(#Gad_Report_ReportList,MyLoop,Column))
            Next
            Range.s = Export_Excel_CellFromRC(1,OnLine)+":"+Export_Excel_CellFromRC(ColumnCount,OnLine)
            
            If CellColour > -1 : XLSFunc_SetColor(ExcelObject, Range ,Red(CellColour),Green(CellColour),Blue(CellColour)) : EndIf
...
Procedure Init_Window_Reporting()
  ...
  ButtonGadget(#Gad_ReportLayout_New,x+450,y,60,20,tTxt(#Str_New))
  ButtonGadget(#Gad_ReportLayout_Edit,x+514,y,60,20,tTxt(#Str_Edit))
  ButtonGadget(#Gad_ReportLayout_Delete,x+578,y,60,20,tTxt(#Str_Delete))
  
  TextGadget(#Gad_ReportLayout_Combo_Text,X+2,Y+4,94,20,tTxt(#Str_SelectLayout)+":",#PB_Text_Right)
  SetGadgetColor(#Gad_ReportLayout_Combo_Text,#PB_Gadget_BackColor,#WinCol_Report)
  ComboBoxGadget(#Gad_ReportLayout_Combo,x+104,Y,340,20)
  Refresh_Layouts()
  SetGadgetState(#Gad_ReportLayout_Combo,0)
  ...
  Select System\Window_Main_Events
    ...
    Case #PB_Event_Gadget
      ...
      Select System\LastSelectedGadget
        ...
        Case #Gad_Report_Preset_Combo, #Gad_ReportLayout_Combo
          Report_Generate(System\Last_Drawn_Report_SiteId,System\Last_Drawn_Report_GroupId)
...
; CursorPosition = 8686
; FirstLine = 4368
; Folding = xICAAAAIAAAAAgCPBAAAQ1ecCAAwhQnESzsAgx
; EnableXP
; EnableUser
