...
Else
  Program_Version.S = " V1.25 - Multi-Site " ;/DNT
EndIf
...
Procedure Init_Window_RollTransfer()
  ;/ Move & Replicate mode.
  Protected X.i, Y.i, Event.i, Changed.i, Quit.i, Pos.i, RollsSelected.i, State.i, SubLevel.i, Selected.i, AddPos.i, MyLoop.i, GroupIDToMoveTo.i, Time.i
  
  OpenWindow(#Window_RollTransfer,0,0,640,480,"Roll Transfer:",#PB_Window_SystemMenu|#PB_Window_WindowCentered,WindowID(#Window_Main))
  SetGadgetFont(#PB_Default,FontID(#Font_List_Dialogs))
  
  X = 4 : Y = 4

  FrameGadget(#Gad_RollTransfer_From_Frame,X,Y,312,450,"Transfer FROM:") 
  X + 5 : Y + 14
  TreeGadget(#Gad_RollTransfer_From_Tree,X,Y,300,428,#PB_Tree_CheckBoxes)
 
  X = 320 :  Y = 4
  
  FrameGadget(#Gad_RollTransfer_To_Frame,X,Y,312,450,"Transfer TO:") 

  X + 5 : Y + 14
  TreeGadget(#Gad_RollTransfer_To_Tree,X,Y,300,428,#PB_Tree_CheckBoxes)
  
  ButtonGadget(#Gad_RollTransfer_Transfer,220,456, 200,22,">> Transfer: 0 Rolls >>") 
  ButtonGadget(#Gad_RollTransfer_Cancel,556, 458, 80,20,"Cancel")
  ...
  Repeat
    ...
    If Changed = 1
      ...
      SetGadgetText(#Gad_RollTransfer_Transfer,">> Transfer: "+Str(RollsSelected)+" Rolls >>") 
  ...
  If Quit = 2 ;/ Transfer selected rolls
    ...
    MessageRequester("Roll Transfer Information...","Roll transfer complete: " + Chr(10) + Chr(10) + "Moved "+Str(RollsSelected)+" Rolls;");+Chr(10)+Chr(10)+"Time: "+Str(Time)+"ms")
...
; CursorPosition = 663
; FirstLine = 634
; Folding = RAAAACAEAAAgAYCAGAAAkAAAAAAAgQAAg-
; EnableUnicode
; EnableXP
; EnableUser
; UseIcon = Images\AniCAM_Mini_T.ico
; Executable = Executable\Anilox Management System v1.25 test.exe
; DisableDebugger
; Debugger = IDE
; EnablePurifier
