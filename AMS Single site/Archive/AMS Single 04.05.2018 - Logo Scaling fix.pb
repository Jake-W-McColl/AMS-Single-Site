...
If Multi_Site_Mode = 0
  Program_Version.s = " V1.5c - Single-Site " ;/DNT
Else
  Program_Version.s = " V1.5c - Multi-Site " ;/DNT
EndIf
...
;   SQL + "[TopSnapImage] LONGBIN
  ...
  Date = GetGadgetState(#Gad_Rollinfo_DateMade_Date)
  If Date < 0 : Date = 0 : EndIf
  Txt.s + "', DateMade = "+Str(Date) ;/DNT
...
; CursorPosition = 5432
; FirstLine = 2375
; Folding = wtBA1AAAgAAAADAIgILrAgAgZcIAoI+QhBi
; EnableXP
; EnableUser
; UseIcon = Images\AniCAM_Mini_T.ico
; Executable = Executable\Anilox Management System v1.5c.exe
; Warnings = Display
; EnablePurifier
