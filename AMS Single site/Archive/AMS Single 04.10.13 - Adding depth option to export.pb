...
If Multi_Site_Mode = 0
  Program_Version.S = " V1.23 - Single-Site " ;/DNT
Else
  Program_Version.S = " V1.23 - Multi-Site " ;/DNT
EndIf
...
Procedure Redraw_Report(SiteID.l,GroupID.l) ;/ Must pass selected Group - Show all rolls assigned to that particaulr Group, along with Roll Statistics
  ...
  Select GetGadgetState(#Gad_Report_SortBy_Combo)
    Case #Report_Sort_RollID
      Filter + " Order by Replace(Name,'-','')+0"  ;/DNT
...
; CursorPosition = 695
; FirstLine = 662
; Folding = HAAAEACAAAAwAIAACYGAAAAAQhQgGAAAu+
; EnableUnicode
; EnableXP
; UseIcon = Images\AniCAM_Mini_T.ico
; Executable = Executable\Anilox Management System v1.23.exe
; Debugger = IDE
; EnablePurifier
