...
If Multi_Site_Mode = 0
  Program_Version.s = " V1.5h - Single-Site " ;/DNT
Else
  Program_Version.s = " V1.5h - Multi-Site " ;/DNT
EndIf
      ...
      If ExamineDirectory(0,File+"AMS\","*.txt")
        While NextDirectoryEntry(0)
          If DirectoryEntryType(0) = #PB_DirectoryEntry_File
            If DirectoryEntrySize(0) > 200 And DirectoryEntrySize(0) < 1024 ;/ falls within range of typical ams licence file
...
; CursorPosition = 7174
; FirstLine = 1208
; Folding = RAAAAAAAAAAAAAAAAABAAwAAAAABAAIzAGh
; EnableXP
; EnableUser
