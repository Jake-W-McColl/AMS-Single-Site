...
Procedure Init_Window_RollTransfer()
  ...
  FrameGadget(#Gad_RollTransfer_From_Frame,X,Y,312,450,tTxt(#Str_TransferFROM)+":") 
  X + 5 : Y + 14
  TreeGadget(#Gad_RollTransfer_From_Tree,X,Y,300,428,#PB_Tree_CheckBoxes)
 
  X = 320 :  Y = 4
  
  FrameGadget(#Gad_RollTransfer_To_Frame,X,Y,312,450,tTxt(#Str_TransferTO)+":") 

  X + 5 : Y + 14
  TreeGadget(#Gad_RollTransfer_To_Tree,X,Y,300,428,#PB_Tree_CheckBoxes)
  
  ButtonGadget(#Gad_RollTransfer_Transfer,220,456, 200,22,">> "+tTxt(#Str_Transfer)+": 0 "+tTxt(#Str_Rolls)+" >>") 
...
; CursorPosition = 10271
; FirstLine = 1278
; Folding = QAAAAAAAgBAAAwEAMAIAIBAAAAAAAhEEQ-
; EnableUnicode
; EnableXP
; EnableUser
; UseIcon = Images\AniCAM_Mini_T.ico
; Executable = Executable\Anilox Management System v1.25.exe
; Debugger = IDE
; EnablePurifier
