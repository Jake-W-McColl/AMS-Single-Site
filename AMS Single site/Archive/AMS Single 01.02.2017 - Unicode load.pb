...
If Multi_Site_Mode = 0
  Program_Version.s = " V1.5 - Single-Site " ;/DNT
Else
  Program_Version.s = " V1.5 - Multi-Site " ;/DNT
EndIf
...
Procedure PDF_Header()
  pdf_ImageMem("Troika AMS.png",System\OEM_ImageBuffer,System\OEM_ImageBufferSize,10,4,50,20)  ;/DNT
...
; CursorPosition = 12117
; FirstLine = 1636
; Folding = QaAAJAAAIYAAAAAAAAIAAAAAAAAgAAAQYA5
; EnableXP
; EnableUser
