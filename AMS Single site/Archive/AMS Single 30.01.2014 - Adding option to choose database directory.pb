...
If Multi_Site_Mode = 0
  Program_Version.S = " V1.24 - Single-Site " ;/DNT
Else
...
Procedure.i MS_CheckDatabaseLocation(Reassign.i=0)
  ...
  If System\Database_Path = "" Or Reassign > 0
    ;Debug 
    If Reassign = 0
      MessageRequester("Message:","The current database isn't set, please specify your database ('AMS_SS.db') location on the next screen") ;/TD
    EndIf
  ...
  Else
    ...
    Path.s = OpenFileRequester("Please specify the database file","","AMS Database (AMS_MS.db)|AMS_SS.db",0) ;/TD
...
; CursorPosition = 5435
; FirstLine = 2385
; Folding = VAAEACCAAAAgA5CACYHAsAAEUAAAA-----
; EnableUnicode
; EnableXP
