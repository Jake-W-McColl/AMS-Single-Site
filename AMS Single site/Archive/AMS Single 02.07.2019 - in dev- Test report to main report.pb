...
Global Program_VersionI.i = 1061 ;/ 
;/ ************************************************************************************
...
If Multi_Site_Mode = 0
  Program_Version.s = " V1.61 - Single-Site " ;/DNT
Else
  Program_Version.s = " V1.61 - Multi-Site " ;/DNT
EndIf
...
;  #Gad_Reading_Quantity_Combo
  ...
  #Gad_Presets_AddGeneralHistoryCombo
...
Global WinInfo.WinScale, System.SystemVariables, RollInfo.RollInformation, AMS_Import.AMSFile, Colours.Colours
  ...
  ForEach ReportData()
    ...
    For MyLoop = 1 To Report_PresetList()\Fieldcount
      ...
      Select Report_PresetList()\FieldBreakdown[myLoop]\Value
        ...
        Case #ReportField_GeneralHistory
          Txt + GeneralHistoryLookup(Str(ReportData()\ID)+Report_PresetList()\FieldBreakdown[myLoop]\GHString) + Chr(10)
...
Procedure Report_Generate_Old(SiteID.l,GroupID.l) ;/ Must pass selected Group - Show all rolls assigned to that particular Group, along with Roll Statistics
  Protected GroupName.s, RollCount.i, ResultS.s, Length.i, VarAmount.f, OnRow.i
...
Procedure Refresh_Manufacturer_List()
  ...
  EndIf 
EndProcedure
Procedure Refresh_Presets_List(KeepSelection.i = #False)
  Protected myLoop.i, onfield.i, CVal.i
  ...
  If DatabaseQuery(#Databases_Master,"Select ID, Name, SQL, FieldSelection From AMS_ReportPresets") ;/ 
    ...
    If IsGadget(#Gad_Report_Preset_Combo)
      CVal = GetGadgetState(#Gad_Report_Preset_Combo)
      ...
      Select KeepSelection
        Case 1
          SetGadgetState(#Gad_Report_Preset_Combo,CVal)
        Case 2
          SetGadgetState(#Gad_Report_Preset_Combo,CountGadgetItems(#Gad_Report_Preset_Combo))
        Default
...
Procedure Init_Presets(Type.i)
  ...
  Width.i = 730 : Height.i = 350 : Editting = 0
  ...
  FrameGadget(#Gad_Presets_FieldSelection_Frame,430,4,360,320,tTxt(#Str_ReportFieldSelection))
  ListViewGadget(#Gad_Presets_FieldSelection,440,20,140,228)
  ...
  ButtonGadget(#Gad_Presets_Add,440,252,140,20,tTxt(#Str_Addselectedfield)+" >>")
  ButtonGadget(#Gad_Presets_AddGeneralHistory,440,274,140,20,tTxt(#Str_AddGeneralHistoryfield))
  ComboBoxGadget(#Gad_Presets_AddGeneralHistoryCombo,460,294,100,20)
  
  ;/ populate General history table
  DatabaseQuery(#Databases_Master,"SELECT DISTINCT Type from AMS_General_History;")
  While NextDatabaseRow(#Databases_Master)  
    AddGadgetItem(#Gad_Presets_AddGeneralHistoryCombo,-1,GetDatabaseString(#Databases_Master,0))
  Wend 
  FinishDatabaseQuery(#Databases_Master)
  SetGadgetState(#Gad_Presets_AddGeneralHistoryCombo,0)
  
  ListViewGadget(#Gad_Presets_FieldList,584,20,140,228)
  ButtonGadget(#Gad_Presets_FieldList_OrderUp,584,252,140,20,tTxt(#Str_OrderUp))
  ButtonGadget(#Gad_Presets_FieldList_OrderDown,584,274,140,20,tTxt(#Str_OrderDown))
  ButtonGadget(#Gad_Presets_FieldList_Remove,584,296,140,20,tTxt(#Str_Removeselected))
        ...
        Select EventGadget()
          Case #Gad_Presets_FieldList_Remove
            If GetGadgetState(#Gad_Presets_FieldList) > 0
              If MessageRequester(tTxt(#Str_Removeselected)+"...",tTxt(#Str_Removeselected)+ " ["+GetGadgetItemText(#Gad_Presets_FieldList,GetGadgetState(#Gad_Presets_FieldList))+"], "+tTxt(#Str_areyousure)+"?",#PB_MessageRequester_YesNo) = #PB_MessageRequester_Yes
          ...
          Case #Gad_Presets_AddGeneralHistory
            Txt.s = GetGadgetItemText(#Gad_Presets_AddGeneralHistoryCombo,GetGadgetState(#Gad_Presets_AddGeneralHistoryCombo));InputRequester("Header:", "Please input Header Name:", "")
            If Txt <> ""
              AddElement(Reportfields())
    ...
    If ExcelObject\SetProperty("Visible = #True") = #S_OK ;/DNT
      ...
      If WorkBook
        If View = 0 ;/ Roll report
          ...
          ColumnCount = GetGadgetColumns(#Gad_Report_ReportList)
          ColumnLetter = Chr(65 + ColumnCount)
          ...
          For Myloop = 0 To CountGadgetItems(#Gad_Report_ReportList)-1
            ...
            Debug "CellColour: "+Str(CellColour)
          ...
          XLSFunc_SetRowAutofit(ExcelObject,Range)  ;/DNT
...
Procedure Init_Window_Reporting()
  ...
  ;Val = GetGadgetState(#Gad_Report_Preset_Combo)
  ClearGadgetItems(#Gad_Report_Preset_Combo)
  Refresh_Presets_List()
  SetGadgetState(#Gad_Report_Preset_Combo,0)
...
; CursorPosition = 2139
; FirstLine = 143
; Folding = wAAAAAAAAAAAAAAAAAAAIAAAAAAAAeAQBQoQ9
; EnableXP
; EnableUser
; DPIAware
