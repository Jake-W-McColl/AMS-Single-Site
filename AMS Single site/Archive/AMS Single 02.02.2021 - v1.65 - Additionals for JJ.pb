...
If Multi_Site_Mode = 0
  Program_Version.s = " V1.64 - Single-Site"  ;/DNT
Else
  Program_Version.s = " V1.64 - Multi-Site" ;/DNT
EndIf
...
Procedure Redraw_Graph(RollID.i, RollName.s = "", ForExport = 0)
  ...
  While NextDatabaseRow(#Databases_Master)
    ...
    Select GraphType
      Case #GraphType_Volume, #GraphType_Usage
        ...
        If VolCount = 0 : VolCount = 1 : EndIf
        VolTemp = VolTemp / VolCount
  ...
  If RMC_CreateChart(GadgetID(#Gad_Graph_Image), ChartID, 0, 0, GadgetWidth(#Gad_Graph_Image)-3, GadgetHeight(#Gad_Graph_Image)-3,0,0,1) = #RMC_NO_ERROR
    ...
    If GraphType = #GraphType_Volume Or GraphType = #GraphType_Usage
      ;/ Amber Line
...
; CursorPosition = 4505
; FirstLine = 2163
; Folding = xJCAgAAAAkEAIAAGAAAACAYIEAAAAgCCQgAXIFf5x7
; Markers = 3036
; EnableThread
; EnableXP
; EnableUser
