...
If Multi_Site_Mode = 0
  Program_Version.S = " V1.3b - Single-Site " ;/DNT
Else
  Program_Version.S = " V1.3b - Multi-Site " ;/DNT
EndIf
...
; CursorPosition = 10694
; FirstLine = 2869
; Folding = RAAAAAAAgBAAAwEAMgIAIAAINACAAgAgo+
; EnableUnicode
; EnableXP
; EnableUser
; UseIcon = Images\AniCAM_Mini_T.ico
; Executable = Executable\Anilox Management System v1.3b.exe
; Warnings = Display
; EnablePurifier
