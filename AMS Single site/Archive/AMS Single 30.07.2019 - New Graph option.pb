...
Procedure Database_CheckVersion(Quiet = #True)
  ...
  If Version < 11 ;/ skip a couple of versions to puh through updates on 'inbetween' releases...
    ...
    AddedText + "Version 13 New Layout options added."+Chr(10)                                                                                                                                       ;/DNT
    ...
    AddedText + "Version 13: Usage fields added to support graphing by usage."+Chr(10)   ;/DNT
    NewVersion = 13
...
Procedure Redraw_Graph(RollID.i)
  ...
  If RMC_CreateChart(GadgetID(#Gad_Graph_Image), ChartID, 0, 0, GadgetWidth(#Gad_Graph_Image)-3, GadgetHeight(#Gad_Graph_Image)-3,0,0,1) = #RMC_NO_ERROR
    ...
    Select GraphType
      ...
      Case #GraphType_Usage
        RMC_AddXAxis(ChartID, #ID_REGION, #RMC_XAXISBOTTOM,1,MyLoop+1,MyLoop+1,0,0,0,0,0,"",tTxt(#Str_Usage)+"\12b",DateString,3)
    EndSelect
...
Procedure.i Import_LoadAMS()
  ...
  If OpenFile(1,System\ImportPath+"Anilox Manager Import.ams") ;/ read the AMS header (single string) and close the file  ;/DNT
    ...
    If Left(Txt,1)="?" ;/ PJ 01.02.2017 - Suspect Unicode
      CloseFile(1)
      ;/ replace the string loader as the comments field isn't outputting properly & causing line truncation....
Size = FileSize(System\ImportPath+"Anilox Manager Import.ams")
*mem = AllocateMemory(System\ImportPath+"Anilox Manager Import.ams")
OpenFile(1,File)
ReadData(1,*mem,Size)
CloseFile(1)
OpenConsole()
...
PrintN("End...")
      ...
      Txt = Right(txt,Len(Txt)-1) ;/ remove the buggering FFFE header.....
    EndIf
    CloseFile(1)
  Else
    ProcedureReturn 0
  ...
  With AMS_Import ;/ split the string into its component parts (tab delimited)
    \Header.s = Trim(StringField(Txt,1,Chr(9))) ;/1
...
Procedure Init_Layout(Type.i)
  ...
  AddGadgetItem(#Gad_ReportLayout_FieldSelection,-1,tTxt(#Str_Comments)+": L1");"Comment Line 1")
  AddGadgetItem(#Gad_ReportLayout_FieldSelection,-1,tTxt(#Str_Comments)+": L2");"Comment Line 2")
  AddGadgetItem(#Gad_ReportLayout_FieldSelection,-1,tTxt(#Str_Comments)+": L3");"Comment Line 3")
  ...
  FrameGadget(#Gad_ReportLayout_Filter,x,Y,120,80,"Filter") : Y + 22
...
Procedure Init_Menu()
  ...
  If CreatePopupMenu(6) ;/ Original
    ...
    MenuBar()
    MenuItem(#Menu_Popup6_Original_Usage_Add,"Edit Roll Usage") ;tTxt(#Str_Deleteselectedreadingrecord))
    MenuBar()
  ...
  If CreatePopupMenu(7) ;/ Historical
    ...
    MenuBar()
    MenuItem(#Menu_Popup7_Historical_Usage_Add,"Edit Roll Usage") ;tTxt(#Str_Deleteselectedreadingrecord))
    MenuBar()
...
Procedure Init_Window_Main()
  ...
  AddGadgetItem(#Gad_Graph_Type_Combo,-1,tTxt(#STR_Volume)+" / "+tTxt(#STR_Usage))
...
; CursorPosition = 1859
; FirstLine = 1305
; Folding = ZIAAAABAAAAAAAEAgAAAAQAABAAAEAABAwBAIA5
; Markers = 2883
; EnableXP
; EnableUser
; DPIAware
; UseIcon = Images\AniCAM_Mini_T.ico
; Executable = Executable\Anilox Management System v1.61.exe
; Warnings = Display
; EnablePurifier
