...
;/
;/ March 2013
;/ Bugfix - Making a change to roll info, then moving off and ansering 'yes' to updating it, updated the newly selected RollID, not the originator.
...
If Multi_Site_Mode = 0
  Program_Version.S = " V1.22 - Single-Site " ;/DNT
Else
  Program_Version.S = " V1.22 - Multi-Site " ;/DNT
EndIf
...
Global IniSwitch_NoAdmin.i = 1, IniSwitch_ReportDepths.i
...
Procedure CheckIni()
  ...
  If ReadFile(1,"AMS.ini")
    Repeat
      ...
      EndSelect
    Until Eof(1)
    MessageRequester("","AMS Ini file found and processed")
    CloseFile(1)
  Else
    MessageRequester("","No AMS Ini file found ")
  EndIf
EndProcedure
CheckIni()
...
; IDE Options = PureBasic 5.20 beta 15 LTS (Windows - x86)
; CursorPosition = 678
; FirstLine = 651
; Folding = HAAAMIADgAAAAEAABEAAQAAAIQIQDAAAX-
; EnableUnicode
; EnableXP
