...
If Multi_Site_Mode = 0
  Program_Version.S = " V1.3c - Single-Site " ;/DNT
Else
  Program_Version.S = " V1.3c - Multi-Site " ;/DNT
EndIf
...
; CursorPosition = 736
; FirstLine = 691
; Folding = ZIAAACAAgBAAAwEAMgIAIAAMPQAAAgAgo+
; EnableUnicode
; EnableXP
; EnableUser
; UseIcon = Images\AniCAM_Mini_T.ico
; Executable = Executable\Anilox Management System v1.3c.exe
; Warnings = Display
; EnablePurifier
