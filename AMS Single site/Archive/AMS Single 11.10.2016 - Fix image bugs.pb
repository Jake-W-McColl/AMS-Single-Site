...
If Multi_Site_Mode = 0
  Program_Version.S = " V1.4c - Single-Site " ;/DNT
Else
  Program_Version.S = " V1.4c - Multi-Site " ;/DNT
EndIf
...
; CursorPosition = 5892
; FirstLine = 1125
; Folding = xAAAAQAABAAAAAABAAAAAAAAgAKRkFQAcc-
; EnableXP
; EnableUser
; UseIcon = Images\AniCAM_Mini_T.ico
; Executable = Executable\Anilox Management System v1.4c.exe
; Warnings = Display
; EnablePurifier
